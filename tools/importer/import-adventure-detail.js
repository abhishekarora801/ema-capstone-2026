...
import columnsAdvSpecsParser from './parsers/columns-adv-specs.js';
...
const parsers = {
  ...
  'columns-adv-specs': columnsAdvSpecsParser,
...
const PAGE_TEMPLATE = {
  ...
  urls: ['https://www.wknd.site/us/en/adventures/bali-surf-camp.html'],
  blocks: [
    {
      "name": "carousel-hero",
      "instances": [
...
const TARGET_PATH = '/adventures/bali-surf-camp';
